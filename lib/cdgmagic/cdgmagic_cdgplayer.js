...
function set_file_prefix(file_url_prefixes)
{
    ...
    var gz03 = "https://www.dropbox.com/s/a0pvg12333exp53/sample_project_03.cdg_gz?dl=0" // --> Files 3
    ...
    console.log("cdgmagic_player:file url: "+cdg_file_prefix);
    console.log("cdgmagic_player:audio url: "+audio_file_prefix);
    ...
    xml_file_request.open( "GET", "https:"+cdg_file_prefix, true );
