 ...
 *
 *  Origin:http://cdgmagic.sourceforge.net/html5_cdgplayer/cdgmagic_cdgplayer.js
 *  Tiffany and Mandy was here writing this with Wil
 */
...
function set_file_prefix(file_url_prefixes)
{
    ...
    https://www.dropbox.com/sh/qxnccnaet6hcf2j/AAAV_hf4SREhTsjNnxio2nQ_a?dl=0  -> Folder
    ...
    console.log("cdgmagic_player:file url: "+"../../assets/CDG/"+cdg_file_prefix);
    console.log("cdgmagic_player:audio url: "+"../../assets/CDG/"+audio_file_prefix);
    ...
    //xml_file_request.open( "GET", "../../assets/CDG/"+cdg_file_prefix + ".cdg_gz", true ); // Remove _gz for normal files.
    xml_file_request.open( "GET", "../../assets/CDG/"+cdg_file_prefix, true );
    ...
    vorbis_source_element.src = "../../assets/CDG/"+audio_file_prefix + ".ogg";
    layer3_source_element.src = "../../assets/CDG/"+audio_file_prefix + ".mp3";
