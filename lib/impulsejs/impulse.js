...
Body.prototype.accelerate = function(state, t) {
  //console.log("Body.accelerate: "+state.toString());
  //console.log("Body.accelerate: "+t.toString());
...
Physics.prototype.spring = function(opts) {
  console.log("Physics.spring:opts");
  console.dir(opts);
  console.log("Physics.spring:this");
  console.dir(this);
...
Physics.prototype.accelerate = function(opts) {
  console.log("implulsejs:Physics.accelerate:opts");
  console.dir(opts);
  console.log("implulsejs:Physics.accelerate:this");
  console.dir(this);
